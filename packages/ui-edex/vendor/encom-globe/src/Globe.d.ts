/**
 * Minimal type declaration for the vendored encom-globe (a plain-CJS WebGL
 * globe library, MIT licensed). Only the surface this plugin uses is typed;
 * the library ships no types of its own. Mirrors the previous ambient
 * declaration but for the relative import of the copied source.
 */
